...
class LasHeR(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        self.seq_info_list = self._get_seq_into_list()
    ...
    # def _get_anno_list(self):
    #     anno_list = []
    #     for id in range(len(self.sequence_list)):
    #         seq_path = self._get_sequence_path(id)
    #         bbox = self._read_bb_anno(seq_path)
    #         anno_list.append(bbox)
    #     return anno_list

    def _get_seq_into_list(self):
        anno_list = []
        for id in range(len(self.sequence_list)):
            # seq_path = self._get_sequence_path(id)
            seq_info = self._get_sequence_info(id)
            anno_list.append(seq_info)
        return anno_list
    ...
    def _get_sequence_info(self, seq_id):
        seq_path = self._get_sequence_path(seq_id)
        # bbox = self.anno_list[seq_id]
        bbox = self._read_bb_anno(seq_path)
    ...
    def get_sequence_info(self, seq_id):
        return self.seq_info_list[seq_id]
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        return os.path.join(seq_path, 'visible', vis_frame_names[frame_id]), os.path.join(seq_path, 'infrared',
                                                                                          inf_frame_names[frame_id])
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        if anno is None:
            ...
            anno = self.seq_info_list[seq_id]
        anno_frames = {}
