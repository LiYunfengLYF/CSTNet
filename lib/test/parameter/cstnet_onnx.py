...
def parameters(yaml_name: str, env_num=0):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/cstnet_onnx/%s.yaml' % yaml_name)
    ...
    params.checkpoint = os.path.join(save_dir, "checkpoints/train/cstnet_onnx/%s/%s_ep%04d.onnx" %
