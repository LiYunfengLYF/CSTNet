...
from lib.models.cstnet.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def finetune_track(self, cfg, patch_start_index=1):
        ...
        if len(self.freeze_layer) != 0 and self.freeze_layer[0] == -1:
            self.pos_embed_x.requires_grad = False
            self.pos_embed_z.requires_grad = False
