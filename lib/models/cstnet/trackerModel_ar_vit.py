...
class CSTNet_onnx(nn.Module):
    ...
    def forward(self, template1: torch.Tensor,
                template2: torch.Tensor,
                search1: torch.Tensor,
                search2: torch.Tensor,

                ):
        x, aux_dict = self.backbone(z=[template1,template2], x=[search1,search2],
                                    ce_template_mask=None,
                                    ce_keep_rate=None,
                                    return_last_attn=None, )
