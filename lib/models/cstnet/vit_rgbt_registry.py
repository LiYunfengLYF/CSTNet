...
from lib.models.cstnet.base_backbone import BaseBackbone
from lib.models.cstnet.rgbt_fusion import rgbt_layer
from lib.models.cstnet.utils import recover_tokens, combine_tokens
...
class VisionTransformerCMXB(BaseBackbone):
    """ Vision Transformer
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', rgbt_loc=None, freeze_layer=[]):
        """
        Args:
        ...
        if len(freeze_layer) != 0:
            ...
            if freeze_layer[0] == -1:
                for param in self.patch_embed.named_parameters():
            ...
            for i in freeze_layer:
                if i == -1:
                    ...
                    for param in self.blocks[i].named_parameters():
                        param.requires_grad = False
    ...
    def forward_features(self, z, x):
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if self.rgbt_loc is not None and i in self.rgbt_loc:
                x_v, x_i = self.rgbt_layers[cmx_index](x_v, x_i)
                cmx_index += 1
...
@torch.no_grad()
def _load_weights(model: VisionTransformerCMXB, checkpoint_path: str, prefix: str = ''):
...
def _create_vision_transformer(variant, pretrained=False, default_cfg=None, **kwargs):
    ...
    model = VisionTransformerCMXB(**kwargs)
...
def vit_base_patch16_224_rgbt_register(pretrained=False, **kwargs):
    """
